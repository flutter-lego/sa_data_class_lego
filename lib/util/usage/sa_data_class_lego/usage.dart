...
import '../../../app/backend/data_class_example/check.dart';
...
T _button00 = T("00", onTap: (BuildContext context) async {
  ...
  String data = check.toDataString();

  print('data:$data');

  Check check2 = Check.fromDataString(data);

  print(check2.toMap());
  print('c000:${check2.c000.toMap()}');
  print('j000:${check2.j000[0].toMap()}');
  print('m000:${check2.m000}');
  print('m000:${check2.m000['weight']}');
...
T _button01 = T("01", onTap: (BuildContext context) async {
  ...
  Check check2 = Check.fromMap(map);
